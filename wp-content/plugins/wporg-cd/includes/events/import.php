 ...
 *
 * Reusable import logic for inserting contributor events. Used by the
 * REST webhook endpoint (includes/events/rest-api.php) and any other
 * internal callers that need to persist events.
 */
